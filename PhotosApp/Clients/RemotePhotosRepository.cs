...
namespace PhotosApp.Clients
{
    public class RemotePhotosRepository : IPhotosRepository
    {
        ...
        private IConfigurationManager<OpenIdConnectConfiguration> oidcConfigurationManager;
        ...
        private async Task<HttpResponseMessage> SendAsync(HttpRequestMessage request)
        {
            ...
            var accessTokenValid = await ValidateTokenAsync(accessToken);
        ...
        private async Task<TokenValidationResult> ValidateTokenAsync(string accessToken)
        {
            ...
            var validationParameters = new TokenValidationParameters
            {
                ...
                SignatureValidator = null,//(token, validationParameters) => new JsonWebToken(token)
